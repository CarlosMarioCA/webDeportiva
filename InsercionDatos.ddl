---INSERCIÓN DE DATOS MODELO PÁGINA WEB DEPORTIVA:

--DATOS USUARIO:

INSERT INTO usuario values (1010, 'Carlos', 'camchavezag2@hotmail.com', 666, 'aficionado', 'Bogotá', 'Tennis', 40000, null, null);
INSERT INTO usuario values (1011, 'Rafael', 'Rafael1280@gmail.com', 789, 'profesional', 'Medellin', 'Futbol', 500000, 'Envigado FC', 2000000);
INSERT INTO usuario values (1012, 'Lucia', 'Lucia1011@outlook.com', 214, 'aficionado', 'Bogotá', 'Natacion', 20000, null, null);
...
INSERT INTO usuario values (1018, 'Tatiana', 'tatis@hotmail.com', 934, 'aficionado', 'Bogotá', 'Rugby', 50000, null, null);
INSERT INTO usuario values (1019, 'Felipe', 'oruro@unal.edu.com', 656, 'aficionado', 'Bogotá', 'Voleibol', null, null, null);

---DATOS LUGAR:

INSERT INTO LUGAR values(10010,'Coliseo GrecoRomano','Medellin','Avenida 14-07','Para eventos de lucha grecorromana');
INSERT INTO LUGAR values(10011,'Estadio El Campín','Bogotá','Calle 53','Estadio de fútbol.');
INSERT INTO LUGAR values(10012,'Velódromo Atanasio Girardot','Medellin','Estadio','Usado por patinadores.');
INSERT INTO LUGAR values(10013,'Estadio Atanasio Girardot','Medellin','Estadio','Estadio de futbol');
INSERT INTO LUGAR values(10014,'Cancha Tennisaria','Cali','Calle 47','Práctica para tennis');
INSERT INTO LUGAR values(10015,'Estadio Castilla','Medellin','','Para practicar natación.');
INSERT INTO LUGAR values(10016,'Piscina la Ciénaga','Barranquilla','Calle 12','Para practicar natación.');
INSERT INTO LUGAR values(10017,'Coliseo','Barranquilla','Calle 12','Para practicar natación.');
...
INSERT INTO entrenamiento values (5500, 1016, 10018, 'Práctica de futbol nivel principiante', to_date('13-jun-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5501, 1016, 10018, 'Práctica de futbol nivel intermedio', to_date('13-jun-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5502, 1013, 10014, 'Práctica de futbol nivel avanzado', to_date('13-jun-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5503, 1019, 10011, 'Aeróbicos', to_date('01-may-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5504, 1018, 10011, 'Footing', to_date('05-jul-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5505, 1017, 10013, 'Clase de aeróbicos', to_date('11-may-2020','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5506, 1010, 10011, 'Práctica de tenis nivel principiante', to_date('07-may-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5507, 1010, 10011, 'Práctica de tenis nivel intermedio', to_date('09-may-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5508, 1010, 10011, 'Práctica de tenis nivel avanzado', to_date('11-may-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5509, 1015, 10017, 'Práctica de baloncesto nivel principiante', to_date('22-jul-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5510, 1015, 10017, 'Práctica de baloncesto nivel intermedio', to_date('25-jul-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5511, 1015, 10017, 'Práctica de baloncesto nivel avanzado', to_date('27-jul-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5512, 1012, 10016, 'Práctica de natacion nivel principiante', to_date('17-jun-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5513, 1012, 10016, 'Práctica de natacion nivel intermedio', to_date('20-jun-2019','dd-mon-yyyy'));
INSERT INTO entrenamiento values (5514, 1012, 10016, 'Práctica de natacion nivel avanzado', to_date('22-jun-2019','dd-mon-yyyy'));
